...
public class IntegerSlider extends JSlider implements InputComponent {
    private Color color = new Color(246, 146, 36);

    public IntegerSlider(Dimension2d size, Dimension2d location, String name, int value, int maximum, int minimum) {
    ...
    private class CustomSliderUI extends BasicSliderUI {
        ...
        public void paintTrack(final Graphics g) {
            ...
            g2.setFont(FONT);
            String nameText = IntegerSlider.this.getName() + ":";
            g2.drawString(nameText, 8, g2.getFont().getSize());

            String value = Integer.toString(IntegerSlider.this.getCurrentValue());
            ...
            String minimum = (IntegerSlider.this.getMinimum() / 10d) % 1 == 0 ? Integer.toString((int) (IntegerSlider.this.getMinimum() / 10d)) : Double.toString(IntegerSlider.this.getMinimum() / 10d);
            FrameUtil.drawCenteredString(g2, minimum, 12, slider.getHeight() - 3, FONT);

            String maximum = (IntegerSlider.this.getMaximum() / 10d) % 1 == 0 ? Integer.toString((int) (IntegerSlider.this.getMaximum() / 10d)) : Double.toString(IntegerSlider.this.getMaximum() / 10d);
            FrameUtil.drawCenteredString(g2, maximum, slider.getWidth() - 12, slider.getHeight() - 3, FONT);
        }

        @Override
        public void paintThumb(final Graphics g) {
            g.setColor(IntegerSlider.this.color);
